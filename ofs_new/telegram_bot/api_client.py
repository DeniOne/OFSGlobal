...
class ApiClient:
    ...
    async def send_employee_data(self, employee_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Преобразуем "department" в "division" если есть
        if "department" in employee_data and "division" not in employee_data:
            employee_data["division"] = employee_data.pop("department")
