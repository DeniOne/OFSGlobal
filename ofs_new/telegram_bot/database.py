...
class BotDatabase:
    ...
    def _create_tables(self):
        ...
        self.cursor.execute('CREATE INDEX IF NOT EXISTS idx_employees_telegram_id ON employees(telegram_id)')
    ...
    def get_all_employees(self) -> List[Dict[str, Any]]:
        ...
        try:
            self._connect()
            self.cursor.execute('SELECT * FROM employees WHERE is_active = 1 ORDER BY created_at DESC')
