...
4. 🔄 Разработка страницы должностей (PositionsPage)
5. 🔄 Реализация компонентов для управления должностями
6. 🔄 Проектирование структуры данных для поддержки ERP-функциональности
...
7. 📋 Доработка страницы должностей (PositionsPage) с учетом будущих расширений
8. 📋 Реализация страницы отделов с иерархической структурой
9. 📋 Разработка визуализации матричной структуры организации
